...
def parse_args():
    """
    Parse command-line arguments for the Thermal 3D Vision Project.
    """
    ...
    parser.add_argument('--ma_checkpoint', type=str,
    ...
    parser.add_argument('--output_dir', type=str,
                        default='/home/nfs/inf6/data/cudalab/victorv1/results',
...
def main(args):
    """
    Main function to run the Thermal 3D Vision Project in various modes.

    Modes:
      - generate_annotations: Generate pseudo-ground truth annotations.
      - verify_annotations: Verify annotations.
      - train: Train the model.
      - evaluate: Evaluate on the Freiburg test set.
      - evaluate_ais: Evaluate on AIS test data.
    """
